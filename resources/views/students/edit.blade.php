         ...
         <div class="row">
            <div class="col-md-4">
                  ...
                  <div class="row g-3">
                     <div class="col">
                        <input type="text" class="form-control" placeholder="Tên " id="inputName"
                           aria-label="First name" name='first_name' value="{{$students->first_name}}">
                     </div>
                     <div class="col">
                        <input type="text" class="form-control" placeholder="Họ tên đệm" id="inputName"
                           aria-label="Last name" name='last_name' value="{{$students->last_name}}">
                     </div>
                  </div>
               </div>
               ...
               <div class=" form-group">
                        ...
                        <input type="file" name="avatar" class="form-control" id="inputAvatar[]"value="{{$students->avatar}}">
                     </div>


                     <div class="form-group">
                        <strong> Giới tính </strong>
                        <select class="form-select" aria-label="Chọn giới tính" name="gender" id="selectGender"value="{{$students->gender}}">
                     ...
                     <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="inputDOB" name="birthdate" value="{{$students->birthdate}}">

                     </div>
                     <div class="form-group">
                        <strong> Dân tộc </strong>
                        <select class="form-select" aria-label="Chọn dân tộc" name="ethnic" id="selectEthnic"value="{{$students->ethnic}}">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="hometown" class="form-control" placeholder="Nhập quê quán"value="{{$students->hometown}}">
                     </div>

                     <div class="form-group">
                        <strong> Số điện thoại </strong>
                        <input type="text" name="phone" class="form-control" placeholder="Nhập số điện thoại "value="{{$students->phone}}">
                     </div>

                     <div class="form-group">
                        <strong> Email </strong>
                        <input type="text" name="email" class="form-control" placeholder="Nhập email"value="{{$students->email}}">
                     </div>

                     <div class="form-group">
                        <strong> Khoa </strong>
                        <select class="form-select" aria-label="Chọn khoa" name="faculty_id" id="selectEthnic" value="{{$students->faculty_id}}">
                     ...
                     <div class="form-group">
                        ...
                        <textarea id="inputDescription" class="form-control" name="description">{{$students->description}}</textarea>
                     </div>
                  </div>
               </div>
